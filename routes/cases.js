module.exports = function(app)
{
	...
	app.post('/inputs' , function (req , res ) {
		...
		form.parse(req,function(err,fields,files){
		    ...
		    //Read output file
			fs.readFile(files.outputfile[0].path, function(err, outputfileData) {//'utf8',
				fs.writeFile("./uploads/Mult_test_cases/output/output" + count+".txt",outputfileData, function(error){//'utf8',
					if(error)console.log(error ); 
				});
    		});
    		//Read input file
    		fs.readFile(files.inputfile[0].path, function(err, inputfileData) {//'utf8',
				fs.writeFile("./uploads/Mult_test_cases/input/input" + count + ".txt",inputfileData, function(error){//'utf8',
					if(error)console.log(error ); 
				});
			});
    		console.log(count);
